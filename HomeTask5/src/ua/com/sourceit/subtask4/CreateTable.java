...
public class CreateTable
{
	...
	try
	{
        ...
        sql = "CREATE TABLE Products_in_Order (id INT PRIMARY KEY AUTO_INCREMENT UNIQUE, product_id INT not NULL, order_id INT not NULL, quantity INT NOT NULL, FOREIGN KEY (product_id) REFERENCES Products(product_id),FOREIGN KEY (order_id) REFERENCES Orders (order_id) )"; 
        stmt.executeUpdate(sql);
